...
Begin VB.Form frmAdminEventos 
   ...
   Begin VB.Frame FraLimiteDe 
      ...
      Begin VB.CheckBox chkNoPermitirItems 
         ...
         Width           =   4935
      End
      Begin VB.PictureBox GridTextListaObjetos 
         Height          =   3375
         Left            =   120
         ScaleHeight     =   3315
         ScaleWidth      =   5115
   ...
   Begin VB.Frame frmRestriccionesPersonaje 
      ...
      Begin VB.CheckBox chkArmadas 
         ...
         Width           =   1935
      End
      Begin VB.PictureBox sliderLegionRango 
         Height          =   300
         Left            =   2160
         ScaleHeight     =   240
         ScaleWidth      =   675
         ...
         Width           =   735
      End
      Begin VB.PictureBox sliderArmadaRango 
         Height          =   300
         Left            =   2160
         ScaleHeight     =   240
         ScaleWidth      =   675
   ...
   Begin VB.Frame lblConfigGeneral 
      ...
      Top             =   0
      Width           =   7095
      Begin VB.PictureBox txtCantidadParticipantesTorneo 
         Height          =   330
         Left            =   2700
         ScaleHeight     =   270
         ScaleWidth      =   555
         ...
         Width           =   615
      End
      Begin VB.PictureBox txtCantidadEquiposTorneoMax 
         Height          =   330
         Left            =   3120
         ScaleHeight     =   270
         ScaleWidth      =   675
         ...
         Width           =   735
      End
      Begin VB.PictureBox txtCantidadEquiposTorneoMin 
         Height          =   330
         Left            =   1200
         ScaleHeight     =   270
         ScaleWidth      =   675
         ...
         Width           =   735
      End
      Begin VB.PictureBox txtMaxNivel 
         Height          =   330
         Left            =   2520
         ScaleHeight     =   270
         ScaleWidth      =   555
         ...
         Width           =   615
      End
      Begin VB.PictureBox txtMinNivel 
         Height          =   330
         Left            =   1680
         ScaleHeight     =   270
         ScaleWidth      =   555
      ...
      Begin VB.Frame frmTiempos 
         ...
         Top             =   1440
         Width           =   2895
         Begin VB.PictureBox txtTiempoInscripcion 
            Height          =   330
            Left            =   2120
            ScaleHeight     =   270
            ScaleWidth      =   675
            ...
            Width           =   735
         End
         Begin VB.PictureBox txtTiempoAviso 
            Height          =   330
            Left            =   2120
            ScaleHeight     =   270
            ScaleWidth      =   675
            ...
            Width           =   735
         End
         Begin VB.PictureBox sldMinutosToleranciaDeslogueo 
            Height          =   330
            Left            =   2120
            ScaleHeight     =   270
            ScaleWidth      =   675
      ...
      Begin VB.Frame FraApuestas 
         ...
         Begin VB.TextBox txtApuestasPozoInicial 
            ...
            Width           =   1575
         End
         Begin VB.PictureBox txtTiempoApuestas 
            Enabled         =   0   'False
            Height          =   330
            Left            =   1680
            ScaleHeight     =   270
      ...
      Begin VB.Frame frameSubEvento 
         ...
         Begin VB.Frame frmCaenItems 
            ...
            End
         End
         Begin VB.PictureBox txtAlMejorDe 
            Height          =   330
            Left            =   1800
            ScaleHeight     =   270
            ScaleWidth      =   555
         ...
         Begin VB.Frame frmGanadorQuedaCancha 
            ...
            Top             =   240
            Width           =   3615
            Begin VB.PictureBox sliderDebeEsperar 
               Enabled         =   0   'False
               Height          =   325
               Left            =   2805
               ScaleHeight     =   270
            ...
            Begin VB.CheckBox chkGanadorQuedaEnCancha 
               ...
               Width           =   2295
            End
            Begin VB.PictureBox sliderGanadorCancha 
               Enabled         =   0   'False
               Height          =   325
               Left            =   2800
               ScaleHeight     =   270
   ...
   Begin VB.Frame frmRestriccionesGenerales 
      ...
      Begin VB.CheckBox chkAlMenosTrabajadores 
         ...
         Width           =   2415
      End
      Begin VB.PictureBox txtMaxSumatoriaNiveles 
         Height          =   330
         Left            =   2280
         ScaleHeight     =   270
         ScaleWidth      =   915
         ...
         Width           =   975
      End
      Begin VB.PictureBox txtAlMenosMagicas 
         Height          =   330
         Left            =   2640
         ScaleHeight     =   270
         ScaleWidth      =   555
         ...
         Width           =   615
      End
      Begin VB.PictureBox txtAlMenosSemiMagicas 
         Height          =   330
         Left            =   2640
         ScaleHeight     =   270
         ScaleWidth      =   555
         ...
         Width           =   615
      End
      Begin VB.PictureBox txtAlMenosNoMagicas 
         Height          =   330
         Left            =   2640
         ScaleHeight     =   270
         ScaleWidth      =   555
         ...
         Width           =   615
      End
      Begin VB.PictureBox txtMaxRepeRaza 
         Height          =   330
         Left            =   2160
         ScaleHeight     =   270
         ScaleWidth      =   555
         ...
         Width           =   615
      End
      Begin VB.PictureBox txtCantidadMaximaRepeClase 
         Height          =   330
         Left            =   2160
         ScaleHeight     =   270
         ScaleWidth      =   555
      ...
      Begin VB.CheckBox chkMaxSumatoriaNiveles 
         ...
         Width           =   2025
      End
      Begin VB.PictureBox txtAlMenosTrabajadoras 
         Height          =   330
         Left            =   2640
         ScaleHeight     =   270
         ScaleWidth      =   555
