...
Private pBlanqueado As Boolean
...
Private Sub actualizarcolor()
    ...
    If Not UpDownText.text = "" And valorValido(val(UpDownText.text)) Then
...
Public Property Get blanqueado() As Boolean
   blanqueado = pBlanqueado
End Property

Public Property Let blanqueado(ByVal vNewValue As Boolean)
    pBlanqueado = vNewValue
