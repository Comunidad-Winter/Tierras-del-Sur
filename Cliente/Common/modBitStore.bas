Attribute VB_Name = "HelperBitWise"
'**************************************************************************
...
'
' @author: Agustín Nicolás Méndez (Menduz @ arduz.com.ar)
' @date: 10192009
' @version 1.0.0
...
Public bitwisetable(0 To 31) As Long
...
Public Sub BS_Integer_On(ByRef var As Integer, ByVal bit As Byte)
    var = var Or bitwisetable(bit Mod 16)
End Sub
...
' @date:   10182009
' @returns: long
Public Sub BS_ShiftRight(ByRef var As Long, ByVal bits As Integer)
    ' >>
    var = var \ bitwisetable(bits Mod 32)
End Sub
...
' @date:   10182009
' @returns: long
Public Sub BS_ShiftLeft(ByRef var As Long, ByVal bits As Integer)
    ' <<
    var = var * bitwisetable(bits Mod 32)
End Sub
