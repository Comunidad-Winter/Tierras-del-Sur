...
'Barrin 3/10/03
'Este form USA EL SISTEMA DE PADRINOS, sólo es cargada en caso de que el servidor
'haya definido usarlo. Caso omiso, se cargará el viejo form (llamado ahora frmPasswdSinPadrinos)
