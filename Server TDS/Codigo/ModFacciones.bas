...
Public ArmaduraImperial2_Hombre As Integer 'Segunda jerarquía
Public ArmaduraImperial2_Mujer As Integer 'Segunda jerarquía
...
If UserList(UserIndex).Faccion.RecibioExpInicialReal = 1 Or UserList(UserIndex).Faccion.RecibioExpInicialCaos = 1 Then 'Tomamos el valor de ahí: ¿Recibio la experiencia para entrar?
