...
Public MapByEze As Integer
Public XByEze As Integer
Public YByEze As Integer
'[\]Misery_Ezequiel 11/07/05]
...
'Nacho 9/04/05
Public Const FXMEDITARGIGANTE = 16
'/Nacho 9/04/05
...
Public Const FONTTYPE_PARTY = "~255~200~200~1~0" 'marche
...
Public Type ObjData
    ...
    ForoID As String
    MinHP As Integer ' Minimo puntos de
...
Type UserFlags
    '[Wizard]
    Pescaditos As Byte 'Feo FEo Muy FEO, pero asi lo quiso nacho
    EscuchaParty As Integer
    '[/Wizard]
    Banrazon As String
    Penasas As String
    ...
    Retando As Boolean '¿Esta retado?
    Perdio As Boolean '¿Esta das?
...
Type User
    ...
    LIderdedupla  As Integer
    TyTrabajo  As Byte 'Tipo de trabajo
    Suerte As Integer 'Cantidad de suerte!
    TyTrabajoMod As Integer 'Red de pesca o caña, hacha dorada o comun
End Type
'*********************************************************
'*********************************************************
'*********************************************************
...
Public Arghâl As WorldPos
'[\]Misery_Ezequiel 10/07/05]
Public Errorestaen As String

Public Prision As WorldPos
Public Libertad As WorldPos
Public Antish As Integer
Public Ayuda As New cCola
Public Antisha As Boolean
Public Declare Function GetTickCount Lib "kernel32" () As Long
Public ULVerUp As Date
