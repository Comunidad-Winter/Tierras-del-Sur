...
Public Amatar As String
Public julios As Integer
Public AmatarOro As Single
Public AntiPetsM As Boolean
Public AmatarOn As Boolean
...
Public IntervaloFrioDeNieve As Integer
'[\]Misery_Ezequiel 11/07/05]
