...
Public Function TirarOroNPc(Pos As WorldPos, Obj As Obj, UserIndex As Integer) As WorldPos
On Error GoTo errhandler
    Dim NuevaPos As WorldPos
    NuevaPos.X = 0
    NuevaPos.Y = 0
    ...
    Else
    UserList(UserIndex).Stats.GLD = UserList(UserIndex).Stats.GLD + Obj.Amount
