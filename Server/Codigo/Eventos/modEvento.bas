...
'-------------------------
Public Enum eCuenta                         ' Tipos de Cuenta. TODO. Sacar de Acá.
    ninguna = 0
    estandar = 1
    Premium = 2
    todas = 3
...
Public Type tEventoPlayOffConfig
    parametros As String        ' Todos juegan la misma cantidad de rounds
End Type

Public Type tEventoLigaConfig
    parametros As String                    ' Cada equipo lucha dos veces contra el otro
End Type
...
Public Type tEventoRestriccionClases
    activada As Boolean
    clasesPermitidas As Long                ' Debe ser alguna de estas clases
End Type

Public Type tEventoRestriccionRazas
    activada As Boolean
    razasPermitidas As Long       ' Debe ser alguna de estas alineaciones
End Type
...
Public Type tEventoConfParticipante
    nick As String                          ' Nombre del participante
    index As Integer                        ' Index
End Type

Public Type tEventoConfEquipo
    participantes() As tEventoConfParticipante
End Type
...
Public Type tConfigEvento
    ...
    reglas As tEventoReglas                               ' Reglas a seguir durante el Evento
End Type
